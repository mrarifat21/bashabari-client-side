  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {wishlist.map((item) => (
          <div key={item._id} className="bg-base-100 p-4 shadow-md rounded-xl">
            <img src={item.propertyImage} className="w-full h-48 object-cover rounded-lg" alt="property" />
            ...
            <div className="flex items-center gap-2 mt-1">
              <img src={item.agentImage} className="w-7 h-7 rounded-full" alt="agent" />
