  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {offers.map((offer) => (
          <div key={offer._id} className="border rounded-lg shadow p-4 bg-white">
            <img
            ...
            <p className="text-gray-600 mb-1">Location: {offer.propertyLocation}</p>
            <p className="text-gray-600 mb-1">Agent: {offer.agentName}</p>
            <p className="text-gray-700 font-semibold mb-2">Offered Amount: ${offer.offerAmount}</p>
