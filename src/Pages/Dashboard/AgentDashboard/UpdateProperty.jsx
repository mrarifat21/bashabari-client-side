...
const UpdateProperty = () => {
  ...
  if (isLoading) return <div className="text-center mt-10 text-text bg-base-100 py-20"><span className="loading loading-spinner text-primary"></span></div>;

  return (
    <div className="max-w-2xl mx-auto p-6 bg-base-200 rounded-lg shadow border border-base-300 text-text">
      <h2 className="text-3xl font-bold mb-4 text-center text-primary">Update Property</h2>

      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          <label className="label text-text">Property Title</label>
          <input
            type="text"
        ...
        <div>
          <label className="label text-text">Location</label>
          <input
            type="text"
        ...
        <div>
          <label className="label text-text">Upload Image</label>
          <input
            type="file"
            accept="image/*"
            onChange={handleImageUpload}
            className="file-input file-input-bordered w-full bg-base-100 text-text"
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="label text-text">Minimum Price</label>
            <input
              type="number"
          ...
          <div>
            <label className="label text-text">Maximum Price</label>
            <input
              type="number"
        ...
        <div>
          <label className="label text-text">Agent Name</label>
          <input
            type="text"
            value={property?.agentName}
            readOnly
            className="input input-bordered w-full bg-base-100 text-text"
          />
        </div>
        <div>
          <label className="label text-text">Agent Email</label>
          <input
            type="text"
